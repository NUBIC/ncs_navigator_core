class SurveyorController < ApplicationController
  ...
  def surveyor_finish
    ...
    psc.update_activity_state(InstrumentEventMap.name_of_instrument(@response_set.survey.title), @response_set.person.participant, PatientStudyCalendar::ACTIVITY_OCCURRED) if @response_set.survey
