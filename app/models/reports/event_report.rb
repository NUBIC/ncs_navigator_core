...
module Reports
  class EventReport
    ...
    #
    #  ┌──────────────┐               ┌────────┐                ┌──────┐
    #  │ Event types? ├───────────────┤ Dates? ├────────────────┤ DCs? │
    #  └───────┬──────┘ N             └───┬────┘ N              └──┬───┘
    #          │ Y                        │ Y                      │ Y
    #  ┌───────┴──────────┐     ┌─────────┴──────────┐   ┌─────────┴──────────┐
    #  │ Event.where(...) │     │ SAR for date range │   │   One SAR per DC   │
    #  └───────┬──────────┘     └─────────┬──────────┘   └─────────┬──────────┘
    #          │                          │                        │
    #      ┌───┴────┐ N                ┌──┴───┐ N          ┌───────┴────────┐
    #      │ Dates? ├──────┐           │ DCs? ├────────┐   │   Merge SARs   │
    #      └───┬────┘      │           └──┬───┘        │   └───────┬────────┘
    #          │ Y         │              │ Y          │           │
    #  ┌───────┴────────┐  │      ┌───────┴────────┐   │           │
    #  │ .with_psc_data │  │      │     Filter     │   │           │
    #  └───────┬────────┘  │      └───────┬────────┘   └─────┐     │
    #          │           │              │                  │     │
    #  ┌───────┴────────┐  │   ┌──────────┴──────────────┐   │     │
    #  │     Filter     │  │   │ Event by PSC ideal date ├───┼─────┘
    #  └───────┬────────┘  │   └──────────┬──────────────┘   │
    #   ┌──────┼───────────┘              │                  │
    #   │   ┌──┴───┐ N          ┌─────────┴──────────────┐   │
    #   └───┤ DCs? ├───────┐    │ Select { implied_by? } ├───┘
    #       └──┬───┘       │    └─────────┬──────────────┘
    #          │ Y         │              │
    #  ┌───────┴────────┐  │           ┌──┴───┐
    #  │     Filter     │  │           │ Done │
    ...
    #       └──────┘
    #
    # (The toplevel "DCs?" block has no N alternative because that situation
    # is prevented by this report's initializer.)
    #
    # Returns nothing.
    def run
      begin
