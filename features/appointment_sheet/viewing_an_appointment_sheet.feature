Feature: Viewing an appointment sheet
  ...
  Scenario: The appointment sheet contains the participant's contact information
    ...
    And I see that she has consent of "General"
    And I see that she has consent of "Biospecimens"
    And I see that she has consent of "Environmental Samples"
    ...
    And I see the child has consent of "General"
    And I see the child has consent of "Biospecimens"
    And I see the child has consent of "Genetic Material"
