module NcsNavigator::Core::Surveyor
  ...
  module SurveyTaker
    ...
    # where only one answer is present for a given question.  In that case, the
    # reference identifier on the answer is optional:
    #
    #     q_foo 'what?'
    #     a :string
    #
    ...
    #     end
    #
    # If foo had more than one answer, an ArgumentError would be raised.
    #
