...
module NcsNavigator::Core::Warehouse::ThreePointTwo
  ##
  # Converts the contents of a core instance into appropriate MDES 3.2
  ...
  class OperationalEnumerator
    ...
    age_expression = %q{CAST (date_part('year', age(t.person_dob_date)) AS integer)}
