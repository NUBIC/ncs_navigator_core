  ...
  context "with an authenticated user" do
    ...
    describe "POST create_child" do
      describe "with valid params" do
        ...
        it "creates a new Participant" do
          expect {
            post :create_child,
              ...
              :participant_consent => valid_attributes,
              :person => { :first_name => "fn", :last_name => "ln"}
          }.to change(Participant, :count).by(2) # the creation of the mother and the child
        ...
        it "creates 2 new ParticipantPersonLinks (one for child to mother and one for mother to child)" do
          pending
          expect {
            post :create_child,
              :contact_link_id => contact_link.id, :participant_id => mother.id,
              :participant_consent => valid_attributes,
              :person => { :first_name => "fn", :last_name => "ln"}
          }.to change(ParticipantPersonLink, :count).by(2)
        end
