# -*- encoding : utf-8 -*-
survey "INS_QUE_LIPregNotPreg_INT_LI_P2_V2.0", :instrument_type => 14, :description => "Low-Intensity Interview (Non & Pregnant)", :instrument_version => "2.0" do
  section "Interviewer-completed questions", :reference_identifier=>"LIPregNotPreg_INT" do
    ...
    q_FEMALE_1 "Hello, my name is {{interviewer_name}}. I'm calling from the {{local_study_affiliate}}.
    I'd like to speak with {{p_full_name}}. Is she available?",
    :pick => :one,
    ...
    group "Time and phone interview setup" do
      ...
      condition_B :q_FEMALE_1, "count>0"
      ...
      a_time "Time", :time, :custom_class => "12hr_time"
      a_neg_1 "Refused"
      a_neg_2 "Don't know"
      ...
      q_PHONE "Is this a good phone number to reach {{p_full_name}}?",
      :pick => :one,
      ...
      condition_B :q_PHONE, "count>0"

      label_END_UNAVAIL "Thank you again for speaking with me today. Please ask her to call us at {{toll_free_number}}.",
  ...
  section "Pregnancy screener", :reference_identifier=>"LIPregNotPreg_INT" do
    ...
    condition_B :q_prepopulated_ppg_status, "==", {:integer_value => "1", :answer_reference => "ppg_status"}

    label_PPG_STATUS_2 "PPG Status = 2"
    dependency :rule => "A and B"
    condition_A :q_PREGNANT, "==", :a_2
    condition_B :q_prepopulated_ppg_status, "==", {:integer_value => "2", :answer_reference => "ppg_status"}
  end
  section "Current pregnancy information", :reference_identifier=>"LIPregNotPreg_INT" do
    ...
    condition_D :q_prepopulated_ppg_status, "==", {:integer_value => "1", :answer_reference => "ppg_status"}
    ...
    group "Loss case" do
      ...
      condition_C :q_prepopulated_ppg_status, "==", {:integer_value => "1", :answer_reference => "ppg_status"}
    ...
    a_date "Due Date", :date, :custom_class => "date"
    a_neg_1 "Refused"
    a_neg_2 "Don't know"
    dependency :rule=> "A"
    condition_A :q_PREGNANT, "==", :a_1
    ...
    a_date "Specify", :date, :custom_class => "date"
    a_neg_1 "Refused"
    a_neg_2 "Don't know"
    dependency :rule=> "A"
    condition_A :q_PREGNANT, "==", :a_1
    ...
    group "Birth place information" do
      ...
      a :string, :custom_class => "five_digit_underscore"
      a_neg_1 "Refused"
      a_neg_2 "Don't know"
    end
  ...
  section "Medical history", :reference_identifier=>"LIPregNotPreg_INT" do
    group "Medical history information" do
      ...
      condition_C :q_PREGNANT, "count>0"
      ...
      may wish to verify."
      dependency :rule=>"A or B"
      condition_A :q_HEIGHT_FT, "<", {:integer_value => "4", :answer_reference => "1"}
      condition_B :q_HEIGHT_FT, ">", {:integer_value => "7", :answer_reference => "1"}
      ...
      condition_A :q_HT_INCH, "<", {:integer_value => "0", :answer_reference => "1"}
      condition_B :q_HT_INCH, ">", {:integer_value => "11", :answer_reference => "1"}
      condition_C :q_HT_INCH, ">", {:integer_value => "84", :answer_reference => "1"}
      condition_D :q_HT_INCH, "<", {:integer_value => "48", :answer_reference => "1"}
      ...
      to verify."
      dependency :rule=>"A or B or C or D"
      condition_A :q_WEIGHT, "<", {:integer_value => "90", :answer_reference => "pounds"}
      condition_B :q_WEIGHT, ">", {:integer_value => "400", :answer_reference => "pounds"}
      condition_C :q_WEIGHT_ALT, "<", {:integer_value => "90", :answer_reference => "pounds"}
      condition_D :q_WEIGHT_ALT, ">", {:integer_value => "400", :answer_reference => "pounds"}
  ...
  section "Tobacco and alcohol use", :reference_identifier=>"PREG_VISIT_LI_2" do
    group "Tobacco and alcohol use information" do
      ...
      condition_A :q_DRINK_NOW, "==", :a_1
      condition_B :q_DRINK_NOW, "==", :a_2
      condition_C :q_DRINK_NOW, "==", :a_3
      condition_D :q_DRINK_NOW, "==", :a_4
      condition_E :q_DRINK_NOW, "==", :a_5
  ...
  section "Conclusion", :reference_identifier=>"PREG_VISIT_LI_2" do
    group "Conclusion questions" do
      ...
      in your household age {{local_age_of_minority}} - {{local_age_of_majority}}, [please have her] contact us at {{toll_free_number}}."
      dependency :rule => "A and B"
      condition_A :q_PREGNANT, "!=", :a_5
      condition_B :q_PREGNANT, "count>0"
