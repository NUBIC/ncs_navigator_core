    ...
    describe ".new" do
      ...
      describe "for a mother with one child" do
        ...
        it "knows all the scheduled activities for the mother and child" do
          instrument_plan.activities_for_event('6m').size.should == 2
        end

        it "knows the participant associated with the appropriate instrument" do
          activities = instrument_plan.activities_for_event('6m')
      ...
      describe "for a mother with two children" do
        ...
        it "knows all the instruments for the mother and child" do
          instrument_plan.instruments('6m').size.should == 3
        end

        it "knows all the scheduled activities for the mother and child" do
          instrument_plan.activities_for_event('6m').size.should == 3
        end
  ...
  context "moving through the plan" do
    ...
    describe ".instrument_record_for" do
      ...
      it "returns nil if the Instrument record for this activity does not exist" do
        instrument_plan.next_instrument('birth').should == birth_survey
        instrument_plan.instrument_record_for(birth_survey).should be_nil
      end
      ...
      it "finds the existing Instrument record for this participant activity" do
        ...
        per = Factory(:person, :person_id => instrument_plan.scheduled_activity_for_instrument(sur.title).person_id)
        ins = Factory(:instrument, :survey => sur, :person => per)

        instrument_plan.instrument_record_for(birth_survey).should == ins
      end
      ...
      it "finds the existing Instrument record for the subsequent survey portion of the participant activity that references another survey (assuming a multi-part survey)" do
        ...
        instrument_plan.instrument_record_for(baby_name_survey).should == ins
      end
  ...
  context "specimen collection" do
    describe ".new" do
      ...
      describe "for a mother with one child" do
        ...
        let(:instrument_plan) { InstrumentPlan.new(plan_xp2) }

        it "knows all the instruments for the mother and child" do
          instrument_plan.instruments('birth').size.should == 3
        end

        it "knows all the scheduled activities for the mother and child" do
          instrument_plan.activities_for_event('birth').size.should == 4
        end

        it "knows the participant associated with the appropriate instrument" do
          activities = instrument_plan.activities_for_event('birth')
      ...
      describe "for a mother with two children" do
        ...
        it "knows all the instruments for the mother and child" do
          instrument_plan.instruments('birth').size.should == 5
        end

        it "knows all the scheduled activities for the mother and child" do
          instrument_plan.activities_for_event('birth').size.should == 6
        end
