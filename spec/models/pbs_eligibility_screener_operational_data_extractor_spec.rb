...
describe PbsEligibilityScreenerOperationalDataExtractor do
  ...
  context "extracting person operational data" do
    ...
    it "extracts person operational data from the survey responses" do
      ...
      take_survey(@survey, response_set) do |a|
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_FNAME", 'Jo'
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_MNAME", 'Anna'
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_LNAME", 'Stafford'
        a.date "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PERSON_DOB", '01/01/1981'
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.AGE_RANGE_PBS", age_range
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ETHNIC_ORIGIN", ethnic_group
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PERSON_LANG_NEW", language
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.AGE_ELIG", age_eligible
      end

      response_set.responses.reload
      response_set.responses.size.should == 8

      PbsEligibilityScreenerOperationalDataExtractor.extract_data(response_set)
    ...
    it "does not set negative values for non coded person operational data" do
      ...
      take_survey(@survey, response_set) do |a|
        a.refused "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_FNAME"
        a.refused "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_MNAME"
        a.refused "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_LNAME"
        a.dont_know "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PERSON_DOB"
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.AGE_RANGE_PBS", age_range_refused
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ETHNIC_ORIGIN", ethnic_group_refused
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PERSON_LANG_NEW", language
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.AGE_ELIG", age_eligible
      end
  ...
  describe "address" do
    ...
    it "extracts operational data from the survey responses" do
      ...
      take_survey(survey, response_set) do |a|
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ADDRESS_1", '123 Easy St.'
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ADDRESS_2", ''
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.UNIT", ''
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.CITY", 'Chicago'
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.STATE", state
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ZIP", '65432'
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ZIP4", '1234'
      end
    ...
    it "does not set negative values for non coded attributes" do
      ...
      take_survey(survey, response_set) do |a|
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ADDRESS_1", '123 Easy St.'
        a.refused "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ADDRESS_2"
        a.dont_know "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.UNIT"
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.CITY", 'Chicago'
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.STATE", state
        a.refused "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ZIP"
        a.dont_know "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ZIP4"
      end
    ...
    it "does not set invalid values" do
      ...
      take_survey(survey, response_set) do |a|
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ADDRESS_1", '123 Easy St.'
        a.refused "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ADDRESS_2"
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.UNIT", "123456789987654321"
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.CITY", 'Chicago'
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.STATE", state
        a.refused "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ZIP"
        a.dont_know "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ZIP4"
  ...
  context "extracting telephone operational data from the survey responses" do
    ...
    it "extracts telephone operational data" do
      ...
      take_survey(@survey, response_set) do |a|
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_PHONE_1", '3125551234'
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_PHONE_TYPE1", home
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_PHONE_TYPE1_OTH", ''
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_PHONE_2", '3125554321'
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_PHONE_TYPE2", cell
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_PHONE_TYPE2_OTH", ''
      end
  ...
  it "extracts email information from the survey responses" do
    ...
    take_survey(survey, response_set) do |a|
      a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.R_EMAIL", 'email@dev.null'
    end
  ...
  it "sets the ppg detail ppg status to 1 if the person responds that they are pregnant" do
    ...
    take_survey(survey, response_set) do |a|
      a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PREGNANT", ppg1
    end
  ...
  it "sets the ppg detail ppg status to 2 if the person responds that they are trying to become pregnant" do
    ...
    take_survey(survey, response_set) do |a|
      a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PREGNANT", ppg2
    end
  ...
  it "sets the ppg detail ppg status to 5 if the person responds that they are unable to become pregnant" do
    ...
    take_survey(survey, response_set) do |a|
      a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PREGNANT", ppg5
    end
  ...
  context "determining the due date of a pregnant woman" do
    ...
    it "sets the due date to the date provided by the participant" do
      ...
      take_survey(@survey, @response_set) do |a|
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PREGNANT", ppg1
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_MM", due_date.month
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_DD", due_date.day
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_YY", due_date.year
      end
    ...
    it "calculates the due date based on the date of the last menstrual period" do
      ...
      take_survey(@survey, @response_set) do |a|
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.PREGNANT", ppg1
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_MM", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_DD", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_YY", neg_2

        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_MM", last_period.month
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_DD", last_period.day
        a.str "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_YY", last_period.year
      end
    ...
    it "calculates the due date based on the number of weeks pregnant" do
      ...
      take_survey(@survey, @response_set) do |a|
        ...
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_DD", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.ORIG_DUE_DATE_YY", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_MM", neg_1
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_DD", neg_1
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_YY", neg_1

        a.int "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.WEEKS_PREG", weeks_pregnant
      end
    ...
    it "calculates the due date based on the number of months pregnant" do
      ...
      take_survey(@survey, @response_set) do |a|
        ...
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_DD", neg_1
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_YY", neg_1
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.WEEKS_PREG", neg_2
        a.int "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.MONTH_PREG", months_pregnant
      end
    ...
    it "calculates the due date based on the 1st trimester" do
      take_survey(@survey, @response_set) do |a|
        ...
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.DATE_PERIOD_YY", neg_1
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.WEEKS_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.MONTH_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.TRIMESTER", tri1
      end
    ...
    it "calculates the due date based on the 2nd trimester" do
      take_survey(@survey, @response_set) do |a|
        ...
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.WEEKS_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.MONTH_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.TRIMESTER", tri2
      end
    ...
    it "calculates the due date based on the 3rd trimester" do
      take_survey(@survey, @response_set) do |a|
        ...
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.WEEKS_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.MONTH_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.TRIMESTER", tri3
      end
    ...
    it "calculates the due date when refused" do
      take_survey(@survey, @response_set) do |a|
        ...
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.WEEKS_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.MONTH_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.TRIMESTER", neg_2
      end
    ...
    it "calculates the due date when don't know" do
      take_survey(@survey, @response_set) do |a|
        ...
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.WEEKS_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.MONTH_PREG", neg_2
        a.choice "#{PbsEligibilityScreenerOperationalDataExtractor::INTERVIEW_PREFIX}.TRIMESTER", neg_1
      end
