...
describe "Straddled dependencies" do
  before(:each) do
    ...
    @preceding_response = Factory(:response, :response_set_id => @preceding_rs.id, :answer => @answer_preceding_rs2, :question => @question_preceding_rs, :survey_section_id => @preceding_section )
  end
