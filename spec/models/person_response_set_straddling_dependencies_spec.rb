...
describe "Straddled dependencies" do
  before(:each) do
    ...
    Factory(:response, :response_set => @preceding_rs, :string_value => "whatchamacallit", :answer => @answer_preceding_rs, :question => @question_preceding_rs, :survey_section_id => @preceding_section.id )
  end
