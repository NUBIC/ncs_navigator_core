...
describe SampledPersonsIneligibility do
  ...
  context "record creation" do
    ...
    context "non-birth cohort" do
      before do
        take_survey(@survey, @response_set) do |a|
          ...
          a.choice "#{OperationalDataExtractor::PbsEligibilityScreener::INTERVIEW_PREFIX}.PSU_ELIG_CONFIRM", @does_not_live_in_county
    ...
    context "birth cohort" do
      before do
        take_survey(@survey, @response_set) do |a|
          a.choice "#{OperationalDataExtractor::PbsEligibilityScreener::HOSPITAL_INTERVIEW_PREFIX}.AGE_ELIG", @age_eligible
          a.choice "#{OperationalDataExtractor::PbsEligibilityScreener::HOSPITAL_INTERVIEW_PREFIX}.PSU_ELIG_CONFIRM", @does_not_live_in_county
        end
