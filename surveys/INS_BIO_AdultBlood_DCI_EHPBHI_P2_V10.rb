...
# ID is 4 for the tube_type=5?
    ...
    dependency :rule=>"A or B"
    condition_A :q_CENTRIFUGE_COMMENT, "==", :a_1
    condition_B :q_CENTRIFUGE_COMMENT, "==", :a_2
    ...
    condition_A :q_BLOOD_INTRO, "==", :a_neg_1
    condition_B :q_HEMOPHILIA, "!=", :a_2
    condition_C :q_BLOOD_THINNER, "!=", :a_2
    condition_D :q_CHEMO, "!=", :a_2
    condition_E :q_BLOOD_COMPLETE, "==", :a_neg_1
    condition_F :q_BLOOD_DRAW_COM, "==", :a_1
  end
end