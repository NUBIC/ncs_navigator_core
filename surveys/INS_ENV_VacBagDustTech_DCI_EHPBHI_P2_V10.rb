survey "INS_ENV_VacBagDustTechCollect_DCI_EHPBHI_P2_V1.0" do
  section "Environmental Vacuum Bag Dust Sample Collection Instrument", :reference_identifier=>"VacBagDustTech_DCI" do
    ...
    condition_A :q_VACUUM_TYPE, "==", :a_2
    condition_B :q_VACUUM_TYPE, "==", :a_4
    condition_C :q_VACUUM_TYPE, "==", :a_5
    condition_D :q_VACUUM_TYPE, "==", :a_6
    condition_E :q_VACUUM_TYPE, "==", :a_8
    condition_F :q_VACUUM_TYPE, "==", :a_9
    ...
    q_VAC_USED_OUTSIDE_1 "Since the dust was emptied from your vacuum  has your vacuum been used to clean a place other than your 
    home such as...",
    ...
    q_VAC_USED_OUTSIDE_2 "Since the vacuum bag was changed has your vacuum been used to clean a place other than your home such as...",
    :help_text => "Select all that apply",
    :pick => :any,
    :data_export_identifier=>"VACUUM_BAG_OUTSIDE.VAC_USED_OUTSIDE"
    a_1 "Your car"
    ...
    a_2 "No"
    dependency :rule=>"A"
    condition_A :q_VACUUM_COLLECTED, "==", :a_1
