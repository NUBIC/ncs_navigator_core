survey "INS_QUE_24MMother_INT_EHPBHI_P2_V1.0" do
  ...
  section "Participant verification", :reference_identifier=>"24MMother_INT" do
    ...
    # TODO
    # PROGRAMMER INSTRUCTION: 
    # • IF PARTICIPANT REFUSES TO PROVIDE NAME, INITIALS OR IDENTIFIER C_FNAME AND C_LNAME=-1, USE “YOUR CHILD” FOR C_FNAME IN REMAINDER OF QUESTIONNAIRE.
    ...
    :help_text => "If it appears that the calculated age of the baby is less than 23 months or greater than 28 months, please verify"
    a :integer
  ...
  section "Medications", :reference_identifier=>"24MMother_INT" do
    ...
    q_PRESCRMED "Please list the name of all prescription medicines taken in the past 30 days:",
...
# MED004B/(INTRO_PRESCRMED_2_10). Now let’s talk about the {PRESCRMED}.
    ...
    repeater "Information on prescription medicines:" do
      ...
      is answered and select \"Add Row\" to add the set of questions for the next drug"
      a :string
    ...
    q_OTCMED "Please list the name of all non-prescription medicines taken in the past 30 days:",
    :help_text => "Enter up to 10 medications; if more than 10 medications provided, enter first 10 provided by participant. 
    Probe: Anything else?",
    :pick => :one,
    ...
    repeater "Information on non-prescription medicines:" do
      ...
      q "Interviewer instruction: What drug is first/next from the answer above?",
      :help_text => "Please pick the drug from the list above and put it in the answer. After the set of questions per selected drug 
      is selected, select \"Add Row\" to add the set of questions for the next drug"
      a :string
      ...
      q_OTC_FREQ "How often does {C_FNAME or YOUR CHILD} use or take {OTCMED}?",
      :help_text => "Indicate frequency",
      :pick => :one,
      ...
      q_OTC_FREQ_UNIT "Unit of how often does {C_FNAME or YOUR CHILD} use or take {OTCMED}?",
      :pick => :one,
  ...
  section "Neighborhood characteristics", :reference_identifier=>"24MMother_INT" do
  ...
  section "Tracing questions", :reference_identifier=>"24MMother_INT" do
    ...
    q_C_ADDR1_1 "Address 1 - street/PO Box", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_ADDR1_1"  
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_1, "==", :a_1

    q_C_ADDR_2_1 "Address 2", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_ADDR_2_1"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_1, "==", :a_1

    q_C_UNIT_1 "Unit", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_UNIT_1"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_1, "==", :a_1

    q_C_CITY_1 "City", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_CITY_1"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_1, "==", :a_1

    q_C_STATE_1 "State", :display_type=>"dropdown", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_STATE_1"
    a_1 "AL"
    a_2 "AK"
    a_3 "AZ"
    a_4 "AR"
    ...
    q_C_ZIPCODE_1 "ZIP Code", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_ZIPCODE_1"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_1, "==", :a_1

    q_C_ZIP4_1 "ZIP+4", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_ZIP4_1"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_1, "==", :a_1
    ...
    q_C_UNIT_2 "Unit", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_UNIT_2"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_2, "==", :a_1

    q_C_CITY_2 "City", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_CITY_2"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_2, "==", :a_1
    ...
    q_C_ZIPCODE_2 "ZIP Code", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_ZIPCODE_2"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_2, "==", :a_1

    q_C_ZIP4_2 "ZIP+4", :data_export_identifier=>"TWENTY_FOUR_MTH_MOTHER.C_ZIP4_2"
    a :string
    dependency :rule=>"A"
    condition_A :q_CONTACT_ADDR_2, "==", :a_1
