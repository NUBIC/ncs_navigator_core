survey "INS_QUE_LIPregNotPreg_INT_LI_P2_V2.0" do
  ...
  section "Current pregnancy information", :reference_identifier=>"LIPregNotPreg_INT" do
    ...
    :help_text => "Enter a four digit year, a two digit month, two digit day. 
    ...
    a_neg_2 "Don't know"
    dependency :rule=>"A"
    condition_A :q_DATE_CHECK, "==", :a_valid
    ...
    condition_A :q_DATE_CHECK, "==", :a_invalid
    condition_B :q_DUE_DATE, "==", :a_neg_1
    condition_C :q_DUE_DATE, "==", :a_neg_2    
    ...
    a_neg_2 "Don't know"
    dependency :rule => "A"
    condition_A :q_BIRTH_PLAN, "==", :a_4                        

    q_BIRTH_ADDR "What is the name and address of the place where you are planning to deliver your baby?",
    :pick => :one
    a_1 "Specify"
    a_neg_1 "Refused"
    a_neg_2 "Don't know"    
    ...
    q_B_STATE "State", :display_type=>"dropdown", :data_export_identifier=>"PREG_VISIT_LI_2.B_STATE"
    a_1 "AL"
    a_2 "AK"
    a_3 "AZ"
    a_4 "AR"
  ...
  section "Medical history", :reference_identifier=>"LIPregNotPreg_INT" do
    ...
    q_ENTER_HEIGHT "How tall are you without shoes? ", :pick=>:one
    a_1 "Enter response"
    a_neg_1 "Refused"
    a_neg_2 "Don't know"
    dependency :rule => "A or B"
    ...
    a :integer
    dependency :rule=>"A"
    condition_A :q_ENTER_HEIGHT, "==", :a_1
    ...
    q_ENTER_WEIGHT "How Much do you weigh?", :pick=>:one
    a_1 "Enter response"
    a_neg_1 "Refused"
    a_neg_2 "Don't know"
    dependency :rule => "A or B"
    ...
    q_ENTER_WEIGHT_ALT "What was your weight just before you became pregnant?", :pick=>:one
    a_1 "Enter response"
    a_neg_1 "Refused"
    a_neg_2 "Don't know"
    dependency :rule => "A or B or C or D"
    ...
    a :integer
    dependency :rule=>"A or B"
    condition_A :q_ENTER_WEIGHT, "==", :a_1
    condition_B :q_ENTER_WEIGHT_ALT, "==", :a_1    
