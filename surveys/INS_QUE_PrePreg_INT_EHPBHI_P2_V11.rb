...
#don't have the corresponding identifier
    ...
    q_pre_preg_r_fname "First name", :data_export_identifier=>"PRE_PREG.R_FNAME"
    a :string
    a_neg_1 "Refused"
    a_neg_2 "Don't know"
    dependency :rule=>"A"
    ...
    q_pre_preg_r_lname "Last name", :data_export_identifier=>"PRE_PREG.R_LNAME"
    a :string
    a_neg_1 "Refused"
    a_neg_2 "Don't know"
    dependency :rule=>"A"
    ...
    q_pre_preg_dob_confirm "Is this your birth date?", 
    ...
    q_pre_preg_calc_age_confirmed_dob "Calculated age (as of 'today')"
    a :integer

    q_pre_preg_age_elig "Is participant age-eligible? ", 
    ...
    :help_text => "End the questionare",
    :data_export_identifier=>"PRE_PREG.END"
    dependency :rule=> "A" 
    condition_A :q_pre_preg_age_elig, "==", :a_2
  ...
  section "Medical history", :reference_identifier=>"pre_pregnancy_int_v11" do
    ...
    q_pre_preg_highbp "Have you ever been told by a doctor or other health care provider that you had - 
    ...
    q_pre_preg_highbp_alternative "Have you ever been told by a doctor or other health care provider that you had - 
    ...
    q_pre_preg_diabetes_1 "Have you ever been told by a doctor or other health care provider that you had - 
    ...
    q_pre_preg_diabetes_1_alternative "Have you ever been told by a doctor or other health care provider that you had - 
  ...
  section "Health insurance", :reference_identifier=>"pre_pregnancy_int_v11" do
    ...
    q_pre_preg_insure "Are you currently covered by any kind of health insurance or some other kind of health care plan? ", 
    :pick=>:one,
...
#TODO
    ...
    q_pre_preg_age_home "Can you tell us, which of these categories do you think best describes when your home or building was built?",
    ...
    q_pre_preg_room_mold "In which rooms have you seen the mold or mildew?",
    ...
    q_pre_preg_renovate_room "Which rooms were renovated?",
    ...
    q_pre_preg_decorate_room "In which rooms were these smaller projects done?",
    :help_text => "Probe for any other responses: Any others? Select all that apply", 
    :pick=>:any, 
  ...
  section "Household composition and demographics", :reference_identifier=>"pre_pregnancy_int_v11" do 
    ...
    q_pre_preg_educ "What is the highest degree or level of school that you have completed?",
    :help_text => "Show response options on card to participant.",
     :pick=>:one, 
    ...
    q_pre_preg_maristat "I’d like to ask about your marital status. Are you:",
...
# TODO == • DISPLAY  HARD EDIT IF RESPONSE > HH_MEMBERS 
    ...
    q_pre_preg_income "Of these income groups, which category best represents your combined family income during the last calendar year?",
    :help_text => "Show response options on card to participant.", :pick=>:one, 
  ...
  section "Tracing questions", :reference_identifier=>"pre_pregnancy_int_v11" do  
    ...
    q_pre_preg_contact_fname_1 "What is this person’s first name?",
    ...
    q_pre_preg_contact_lname_1 "What is this person's last name?",
    ...
    q_pre_preg_enter_contact_addr_1 "What is his/her address?",
    ...
    q_pre_preg_enter_contact_phone_1 "What is his/her telephone number (XXXXXXXXXX)?",
...
# *** CONTACT_2 doesn't exist
    ...
    q_pre_preg_enter_contact_2 "What is the person's name?",
    :help_text => "If participant does not want to provide name of contact ask for initials. Confirm spelling of first and last names", 
    :pick=>:one
    a_1 "Specify", :string
    a_neg_1 "Refused"
    ...
    q_pre_preg_contact_fname_2 "What is the person's first name?",
    :help_text => "If participant does not want to provide name of contact ask for initials. Confirm spelling of first and last names", 
    ...
    q_pre_preg_contact_lname_2 "What is the person's last name?",
    :help_text => "If participant does not want to provide name of contact ask for initials. Confirm spelling of first and last names.", 
    ...
    q_pre_preg_enter_contact_addr_2 "What is his/her address?",
    ...
    q_pre_preg_enter_contact_phone_2 "What is his/her telephone number (XXXXXXXXXX)?",
    :help_text => "If contact has no telephone ask for telephone number where he/she receives calls", 
