survey "INS_QUE_PregScreen_INT_HILI_P2_V2.0" do
  ...
  section "Eligibility questions", :reference_identifier=>"PregScreen_INT" do        
    ...
    :help_text => "If there is more than one woman in household, ask to speak to the pregnant one first. If not available, ask if others are available.",
    :pick => :one,
    ...
    q_ADDRESS_VARIABLES "What is your address?",
    ...
    a :string
    dependency :rule=>"A"
    condition_A :q_ADDRESS_VARIABLES, "==", :a_1

    q_ADDRESS_2 "Address 2", :data_export_identifier=>"PREG_SCREEN_HI_2.ADDRESS_2"
    a :string
    dependency :rule=>"A"
    condition_A :q_ADDRESS_VARIABLES, "==", :a_1

    q_UNIT "Unit", :data_export_identifier=>"PREG_SCREEN_HI_2.UNIT",
    :help_text => "Unit type. Unit number"
    a :string
    dependency :rule=>"A"
    condition_A :q_ADDRESS_VARIABLES, "==", :a_1

    q_CITY "City", :data_export_identifier=>"PREG_SCREEN_HI_2.CITY"
    a :string
    dependency :rule=>"A"
    condition_A :q_ADDRESS_VARIABLES, "==", :a_1

    q_STATE "State", :display_type=>"dropdown", :data_export_identifier=>"PREG_SCREEN_HI_2.STATE"
    a_1 "AL"
    a_2 "AK"
    a_3 "AZ"
    a_4 "AR"
    ...
    q_ZIP "ZIP Code", :data_export_identifier=>"PREG_SCREEN_HI_2.ZIP"
    a :string
    dependency :rule=>"A"
    condition_A :q_ADDRESS_VARIABLES, "==", :a_1

    q_ZIP4 "ZIP+4", :data_export_identifier=>"PREG_SCREEN_HI_2.ZIP4"
    a :string
    dependency :rule=>"A"
    condition_A :q_ADDRESS_VARIABLES, "==", :a_1    
  ...
  section "Pregnancy screener", :reference_identifier=>"PregScreen_INT" do        
    ...
    a_neg_1 "Refused"
    a_neg_2 "Don’t know"
    dependency :rule=>"(A or D or E) and (B or C)"
    condition_A :q_DU_ELIG_CONFIRM, "==", :a_1
    condition_B :q_AGE_ELIG, "==", :a_1
    condition_C :q_AGE_ELIG, "==", :a_3
    condition_D :q_DU_ELIG_CONFIRM, "==", :a_2
    condition_E :q_DU_ELIG_CONFIRM, "==", :a_3
    ...
    condition_A :q_TRYING, "==", :a_5
    condition_B :q_TRYING, "==", :a_neg_1
    condition_C :q_TRYING, "==", :a_neg_2
    condition_D :q_PREGNANT, "==", :a_5
    condition_E :q_AGE_ELIG, "==", :a_1
    ...
    condition_A :q_HYSTER, "==", :a_2
    condition_B :q_HYSTER, "==", :a_neg_1
    condition_C :q_HYSTER, "==", :a_neg_2
    ...
    a_neg_2 "Don’t know"
    dependency :rule=>"A or B or C"
    condition_A :q_OVARIES, "==", :a_2
    condition_B :q_OVARIES, "==", :a_neg_1
    condition_C :q_OVARIES, "==", :a_neg_2
    ...
    a_neg_2 "Don’t know"
    dependency :rule=>"A or B or C"
    condition_A :q_TUBES_TIED, "==", :a_2
    condition_B :q_TUBES_TIED, "==", :a_neg_1
    condition_C :q_TUBES_TIED, "==", :a_neg_2
    ...
    a_neg_2 "Don’t know"
    dependency :rule=>"A or B or C"
    condition_A :q_MENOPAUSE, "==", :a_2
    condition_B :q_MENOPAUSE, "==", :a_neg_1
    condition_C :q_MENOPAUSE, "==", :a_neg_2
  ...
  section "Tracing questions", :reference_identifier=>"PregScreen_INT" do        
    ...
    q_MAILING_ADDRESS_VARIABLES "What is your mailing address?",
    ...
    q_MAIL_ADDRESS1 "Address 1 - street/PO Box", :data_export_identifier=>"PREG_SCREEN_HI_2.MAIL_ADDRESS1"  
    a :string
    dependency :rule=>"A"
    condition_A :q_MAILING_ADDRESS_VARIABLES, "==", :a_1

    q_MAIL_ADDRESS2 "Address 2", :data_export_identifier=>"PREG_SCREEN_HI_2.MAIL_ADDRESS2"
    a :string
    dependency :rule=>"A"
    condition_A :q_MAILING_ADDRESS_VARIABLES, "==", :a_1
    ...
    q_MAIL_CITY "City", :data_export_identifier=>"PREG_SCREEN_HI_2.MAIL_CITY"
    a :string
    dependency :rule=>"A"
    condition_A :q_MAILING_ADDRESS_VARIABLES, "==", :a_1

    q_MAIL_STATE "State", :display_type=>"dropdown", :data_export_identifier=>"PREG_SCREEN_HI_2.MAIL_STATE"
    a_1 "AL"
    a_2 "AK"
    a_3 "AZ"
    a_4 "AR"
    ...
    q_MAIL_ZIP "ZIP Code", :data_export_identifier=>"PREG_SCREEN_HI_2.MAIL_ZIP"
    a :string
    dependency :rule=>"A"
    condition_A :q_MAILING_ADDRESS_VARIABLES, "==", :a_1

    q_MAIL_ZIP4 "ZIP+4", :data_export_identifier=>"PREG_SCREEN_HI_2.MAIL_ZIP4"
    a :string
    dependency :rule=>"A"
    condition_A :q_MAILING_ADDRESS_VARIABLES, "==", :a_1
    ...
    q_NEW_ADDRESS1 "Address 1 - street/PO Box", :data_export_identifier=>"PREG_SCREEN_HI_2.NEW_ADDRESS1"  
    a :string
    dependency :rule=>"A"
    condition_A :q_NEW_ADDRESS_VARIABLES, "==", :a_1

    q_NEW_ADDRESS2 "Address 2", :data_export_identifier=>"PREG_SCREEN_HI_2.NEW_ADDRESS2"
    a :string
    dependency :rule=>"A"
    condition_A :q_NEW_ADDRESS_VARIABLES, "==", :a_1

    q_NEW_UNIT "Unit", :data_export_identifier=>"PREG_SCREEN_HI_2.NEW_UNIT"
    a :string
    dependency :rule=>"A"
    condition_A :q_NEW_ADDRESS_VARIABLES, "==", :a_1

    q_NEW_CITY "City", :data_export_identifier=>"PREG_SCREEN_HI_2.NEW_CITY"
    a :string
    dependency :rule=>"A"
    condition_A :q_NEW_ADDRESS_VARIABLES, "==", :a_1

    q_NEW_STATE "State", :display_type=>"dropdown", :data_export_identifier=>"PREG_SCREEN_HI_2.NEW_STATE"
    a_1 "AL"
    a_2 "AK"
    a_3 "AZ"
    a_4 "AR"
    ...
    q_NEW_ZIP "ZIP Code", :data_export_identifier=>"PREG_SCREEN_HI_2.NEW_ZIP"
    a :string
    dependency :rule=>"A"
    condition_A :q_NEW_ADDRESS_VARIABLES, "==", :a_1

    q_NEW_ZIP4 "ZIP+4", :data_export_identifier=>"PREG_SCREEN_HI_2.NEW_ZIP4"
    a :string
    dependency :rule=>"A"
    condition_A :q_NEW_ADDRESS_VARIABLES, "==", :a_1
